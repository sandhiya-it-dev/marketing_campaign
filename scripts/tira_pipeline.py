...
df = pd.read_csv(
    "/Users/sandhiyachandrasekar/marketing_campaign/cleaned_dataset/tira_campaign_data_cleaned.csv"
)
...
pickle.dump(
    ...
    "tira_cosmetics_regressor.pkl"),"wb")
)

pickle.dump(
    clf_model,
    open(os.path.join(model_dir,
    "tira_cosmetics_classifier.pkl"),"wb")
)

pickle.dump(
    trained_columns,
    open(os.path.join(model_dir,
    "tira_cosmetics_model.pkl"),"wb")
)
